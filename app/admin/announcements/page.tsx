      ...
      {filtered.length === 0 ? (
        <div className="bg-white border border-slate-200 rounded-xl p-16 text-center">
          ...
          <p className="text-sm text-slate-400">
            İlk duyuruyu oluşturmak için yukarıdaki butona tıklayın.
          </p>
        </div>
      ) : (
            ...
            <div className="flex items-center justify-between p-6 border-b border-slate-100">
              <div>
                ...
                <p className="text-sm text-slate-500 mt-0.5">
                  {editingId
                    ? "Mevcut duyuruyu güncelleyin"
                    : "Platforma yeni duyuru ekleyin"}
                </p>
              </div>
              <button
                onClick={() => setShowModal(false)}
              ...
              <label className="flex items-center gap-3 p-4 bg-primary/5 border border-primary/20 rounded-xl cursor-pointer hover:bg-primary/10 transition-colors">
                ...
                <div>
                  ...
                  <p className="text-xs text-slate-500">
                    Sabitlenmiş duyurular listenin başında gösterilir
                  </p>
                </div>
              </label>
            </div>
