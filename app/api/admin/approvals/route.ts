    ...
    try {
        ...
        await prisma.notification.create({
            data: {
                userId,
                type: "APPROVAL",
                title: action === "APPROVE" ? "Üyeliğiniz Onaylandı! 🎉" : "Üyelik Başvurunuz Reddedildi",
                message:
                    action === "APPROVE"
        ...
        return NextResponse.json({ message: action === "APPROVE" ? "Kullanıcı onaylandı" : "Kullanıcı reddedildi" });
    } catch (error) {
