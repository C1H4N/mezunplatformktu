...
export default function Footer() {
  ...
  return (
    <footer className="bg-card border-t border-border mt-auto">
      <div className="w-full px-4 sm:px-[4%] py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            ...
            <p className="text-muted text-sm max-w-md leading-relaxed">
              Mezunlarımızı bir araya getiren, kariyer gelişimini destekleyen ve
              networking fırsatları sunan resmi platform.
            </p>
          </div>
        ...
        <div className="mt-8 pt-8 border-t border-border">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            <p className="text-muted text-sm text-center md:text-left">
              © {currentYear} KTÜ Araklı Ali Cevat Özyurt Meslek Yüksekokulu.
