...
export default async function AnnouncementsPage() {
    ...
    const mockAnnouncements = [
        {
            ...
            content: "Değerli mezunlarımız, geleneksel hale getirdiğimiz mezunlar buluşması etkinliğimiz bu yıl büyük bir katılımla gerçekleşecek. Yenilenen kampüsümüzde eski anıları tazelemek ve yeni mezun ağımızı güçlendirmek için hepinizi bekliyoruz.",
        ...
        },
        {
            ...
            content: "Mezun platformumuza entegre ettiğimiz yeni rozet sistemi sayesinde artık profilinize daha yetkinliklerinizi ve elde ettiğiniz başarıları ekleyebilirsiniz. Platform üzerinde aktif kalarak özel rozetler kazanabilirsiniz.",
            imageUrl: null,
            isPinned: false,
        ...
        },
        {
            ...
            content: "Üniversitemiz bilgisayar programcılığı bölümü mezunları ve öğrencileri için düzenlenecek olan kodlama yarışmasına (Hackathon) başvurular başladı. Büyük ödüller sizi bekliyor!",
    ...
    const announcements = rawAnnouncements.length > 0 ? rawAnnouncements : mockAnnouncements;
        ...
        <div className="min-h-screen bg-gray-50 py-12 px-4 sm:px-6 lg:px-8">
            <div className="max-w-5xl mx-auto">
                ...
                <div className="flex items-center gap-4 mb-10">
                    ...
                    <div>
                        <h1 className="text-3xl font-extrabold text-gray-900 tracking-tight">Duyurular & Haberler</h1>
                        <p className="text-gray-500 mt-1">Platformumuz ve üniversitemizle ilgili en güncel gelişmeleri takip edin.</p>
                    </div>
                </div>
                ...
                <div className="grid gap-6">
                        ...
                        >
                            ...
                            <div className="p-6 sm:p-8 flex-1 flex flex-col justify-between">
                                <div>
                                    ...
                                    <h2 className={`text-xl font-bold mb-3 ${announcement.isPinned ? 'text-gray-900' : 'text-gray-800'}`}>
                                        {announcement.title}
                                    </h2>
                                    ...
                                    <div className="flex items-center gap-2.5">
                                        <div className="w-8 h-8 rounded-full bg-gray-200 overflow-hidden flex items-center justify-center text-gray-500">
                                            {announcement.author.image ? (
                                                <Image src={announcement.author.image} alt="User" width={32} height={32} className="object-cover" />
                                            ) : (
                    ...
                    {announcements.length === 0 && (
                        <div className="text-center py-24 bg-white rounded-3xl border border-gray-100 border-dashed">
                            ...
                            <h3 className="text-lg font-medium text-gray-900">Henüz Bir Duyuru Yok</h3>
                            <p className="text-gray-500 mt-1">Sistemde şu an için aktif bir duyuru bulunmamaktadır.</p>
                        </div>
                    )}
                </div>
