...
Geliştirilecek mezun platformu, üniversite mezunları, aktif öğrenciler, Akademisyen/Bölüm Başkanıler ve üniversite yönetimi arasında dijital bir etkileşim ve iletişim ortamı sunmayı hedeflemektedir.

Sistem kapsamında aşağıdaki temel işlevler yer almaktadır:

- Kullanıcı kayıt, giriş ve kimlik doğrulama işlemleri
- Mezun, öğrenci, akademisyen ve bölüm başkanı profillerinin oluşturulması ve yönetilmesi
...
| Akademisyen | Üniversitede görevli eğitim personeli |
| Bölüm Başkanı | Bölüm yönetim ve etkinlik denetiminden sorumlu yetkili |
...
Mezun platformu, üniversitenin mezun-öğrenci-akademisyen ekosistemini tek bir dijital çatı altında toplamayı hedefleyen merkezi bir sistem olarak konumlandırılmaktadır.
...
**3.5 Akademisyen/Bölüm Başkanı Kullanıcısı**

Akademisyen/Bölüm Başkanı; platform üzerinden iş veya staj ilanı yayınlamak isteyen kurum veya firma temsilcisidir.
...
- Sistem ayarlarına erişemez
- Diğer Akademisyen/Bölüm Başkanı hesaplarını yönetemez
...
| **İşlem / Rol** | **Öğrenci** | **Mezun** | **Akademisyen/Bölüm Başkanı** | **Moderatör** | **Admin** |
| --- | --- | --- | --- | --- | --- |
| Profil oluşturma | ✓   | ✓   | ✓   | ✓   | ✓   |
| İlan görüntüleme | ✓   | ✓   | ✓   | ✓   | ✓   |
| İlan oluşturma | ✗   | ✗   | ✓   | ✗   | ✓   |
...
**Açıklama:  
**Sistem; öğrenci, mezun ve Akademisyen/Bölüm Başkanı kullanıcılarının platforma kayıt olabilmesini sağlamalıdır. Kayıt süreci kullanıcı rolüne göre farklı doğrulama adımlarını içerebilir.

**Aktörler:  
**Öğrenci, Mezun, Akademisyen/Bölüm Başkanı
...
- Kullanıcı rolünü seçer (Öğrenci / Mezun / Akademisyen/Bölüm Başkanı).
...
**Akademisyen/Bölüm Başkanı Profili:**
...
- Sadece Akademisyen/Bölüm Başkanıler
- Gizli

**İş Kuralları:**

- E-posta ve telefon bilgileri varsayılan olarak gizli olmalıdır.
- Akademisyen/Bölüm Başkanıler, yalnızca izin verilen alanları görüntüleyebilir.
...
**Açıklama:  
**Sistem, Akademisyen/Bölüm Başkanı kullanıcılarının ve yetki verilmiş adminlerin iş ve staj ilanları oluşturabilmesini sağlamalıdır.

**Aktörler:  
Akademisyen/Bölüm Başkanı, Admin**

**Ön Koşullar:**

- Kullanıcı sisteme giriş yapmış olmalıdır.
- Akademisyen/Bölüm Başkanı hesabı onaylanmış olmalıdır.
...
- Akademisyen/Bölüm Başkanı "İlan Oluştur" ekranına girer.
...
**Açıklama:  
**Akademisyen/Bölüm Başkanıler yayınladıkları ilanları güncelleyebilmeli veya yayından kaldırabilmelidir.
...
**Aktörler:  
**Öğrenci, Mezun, Akademisyen/Bölüm Başkanı, Admin
...
- Akademisyen/Bölüm Başkanıe bildirim gönderilir.
...
**Açıklama:  
**Akademisyen/Bölüm Başkanıler, ilanlarına yapılan başvuruları görüntüleyip değerlendirebilmelidir.
...
**Aktörler:  
**Öğrenci, Mezun, Akademisyen/Bölüm Başkanı, Moderatör, Admin
...
- Öğrenciler yalnızca mezunlar ve Akademisyen/Bölüm Başkanılerle mesajlaşabilir.
- Akademisyen/Bölüm Başkanıler yalnızca başvuru yapan veya iletişime izin veren kullanıcılarla mesajlaşabilir.
...
- Profil ID
- Kullanıcı ID (FK)
- Profil türü (Öğrenci / Mezun / Akademisyen/Bölüm Başkanı)
- Profil açıklaması
- Görünürlük ayarları
- Profil fotoğrafı
...
- Bir ilan yalnızca bir Akademisyen/Bölüm Başkanıe ait olabilir.
