...
"[project]/lib/schemas/register.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const registerSchema = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v4$2f$classic$2f$external$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].object({
    firstName: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v4$2f$classic$2f$external$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].string().min(2, "Ad en az 2 karakter olmalı.").max(50, "Ad en fazla 50 karakter olabilir."),
    lastName: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v4$2f$classic$2f$external$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].string().min(2, "Soyad en az 2 karakter olmalı.").max(50, "Soyad en fazla 50 karakter olabilir."),
    email: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v4$2f$classic$2f$external$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].email("Geçerli bir e-posta adresi giriniz."),
    phoneNumber: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v4$2f$classic$2f$external$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].string().min(10, "Telefon numarası en az 10 haneli olmalı.").max(15, "Telefon numarası en fazla 15 haneli olabilir.").regex(/^\d+$/, "Telefon numarası yalnızca rakamlardan oluşmalıdır."),
    password: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v4$2f$classic$2f$external$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].string().min(8, "Şifre en az 8 karakter olmalı.").max(50, "Şifre en fazla 50 karakter olabilir."),
    confirmPassword: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v4$2f$classic$2f$external$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].string().min(8, "Şifre tekrarı en az 8 karakter olmalı.").max(50, "Şifre tekrarı en fazla 50 karakter olabilir.")
 ...
 */ const config = {
    "generator": {
        ...
        "output": {
            "value": "/home/ashetian/projects/mezunplatformktu/app/generated/prisma",
            "fromEnvVar": null
        },
        "config": {
            "engineType": "library"
        ...
        "previewFeatures": [],
        "sourceFilePath": "/home/ashetian/projects/mezunplatformktu/prisma/schema.prisma",
        "isCustomOutput": true
    },
    "relativeEnvPaths": {
        "rootEnvPath": null,
...
const prisma = globalForPrisma.prisma || new __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$generated$2f$prisma$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["PrismaClient"]({
    datasources: {
        db: {
            url: process.env.INTERNAL_DATABASE_URL ? process.env.INTERNAL_DATABASE_URL : process.env.DATABASE_URL
        }
    }
});
...
"[project]/lib/utils/getZodFieldErrors.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function getZodFieldErrors(error) {
...
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$schemas$2f$register$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/lib/schemas/register.ts [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/lib/db.ts [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$utils$2f$getZodFieldErrors$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/lib/utils/getZodFieldErrors.ts [app-route] (ecmascript)");
...
async function POST(req) {
    ...
    const schema = __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$schemas$2f$register$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["registerSchema"].safeParse(body);
    if (!schema.success) {
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            message: "Kullanıcı kaydı oluşturulamadı.",
            errors: (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$utils$2f$getZodFieldErrors$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getZodFieldErrors"])(schema.error)
        });
    }
...
//# sourceMappingURL=%5Broot-of-the-server%5D__d5acc4c6._.js.map