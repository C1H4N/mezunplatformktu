...
"[project]/app/generated/prisma/runtime/library.js [app-ssr] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
...
"[project]/app/generated/prisma/index.js [app-ssr] (ecmascript)", ((__turbopack_context__, module, exports) => {
    ...
    providers: [
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$auth$2f$core$2f$providers$2f$credentials$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"])({
            ...
            async authorize (credentials) {
                ...
                const user = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].user.findFirst({
                    where: {
                        OR: [
                            {
                                email
                ...
                const isValid = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$bcryptjs$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].compare(password, user.password);
                if (!isValid) throw new Error("Geçersiz şifre.");
                await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].user.update({
                    where: {
                        id: user.id
                    },
                    data: {
...
function LoginPage() {
    ...
    const handleSubmit = async (e)=>{
        ...
        try {
            ...
            const res = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$auth$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["signIn"])("credentials", {
            ...
            setLoading(false);
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$hot$2d$toast$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].error("Beklenmeyen bir hata oluştu: " + err.message);
        }
    };
...
//# sourceMappingURL=%5Broot-of-the-server%5D__c8468254._.js.map